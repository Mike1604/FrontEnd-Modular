  ...
  return <div className={"main_container"}>
    <div className="top">
      ...
      <div className="shortcuts">
        <button className="button_style create_package" onClick={() => navigate('/crear-baraja')}>Crear paquete</button>
        <button className="button_style white_text create_new_auto_card" onClick={() => navigate('/crear-carta')}>Crear carta automaticamente</button>
        <button className="button_style white_text create_new_auto_card">Crear carta manualmente</button>
